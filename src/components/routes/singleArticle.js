  ...
  return (
    <div className="app__single-article">
      <article className="single-article">
        <img className="single-article__img" src={imgSrc} alt={imgDesc} />
        <a className="single-article__author" href={authorLink}>{authorName}</a>
        <time className="single-article__time" dateTime={date}>{postDateTime}</time>
        <span className="single-article__likes">{likesAmount}</span>
        <button className="single-article__like-btn" type="button">
          <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
            ...
            2.187-6.281 6.191 0 4.661 5.571 9.429 12 15.809 6.43-6.38 12-11.148 12-15.809 0-4.011-3.095-6.181-6.274-6.181"/>
          </svg>
        </button>
      </article>
    </div>
